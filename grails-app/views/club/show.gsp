	...
	<body>
		<div id="show-club" class="content scaffold-show" role="main">
			...
			<ol class="property-list club">
				...
				<g:if test="${clubInstance?.clubName}">
				<li class="fieldcontain">
					<span id="clubName-label" class="property-label"><g:message code="club.clubName.label" default="Club Name" /></span>
					
						<span class="property-value" aria-labelledby="clubName-label"><g:fieldValue bean="${clubInstance}" field="clubName"/></span>

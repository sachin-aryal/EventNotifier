...
class EventController {
    ...
    def homepage(){
        def clubList=Club.list()
        render  view:'homepage',model:[clubList:clubList]
    }
    def clubEvent(){
        def eventList=Event.findAllByClub(Club.findById(params.id as long))
        render view:'index',model:[eventInstanceList:eventList,eventInstanceCount: eventList.size()]
    }
}
